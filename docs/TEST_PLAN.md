...
A release is blocked by failing tests/builds/formatting/analyzers, unresolved high-severity dependency findings, known secret/path leakage, a broken migration/restore compatibility path, an unbounded untrusted resource parameter, or an unreviewed cryptographic format change.
