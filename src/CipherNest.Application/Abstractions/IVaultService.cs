...
public interface IVaultService
{
    ...
    Task CreateAsync(string masterPassphrase, CancellationToken cancellationToken = default);
    Task UnlockAsync(string masterPassphrase, CancellationToken cancellationToken = default);
